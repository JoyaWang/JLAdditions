#
#  Be sure to run `pod spec lint JLAdditions.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Joya"
  # spec.authors            = { "Joya" => "244092911@qq.com" }
  # spec.social_media_url   = "https://twitter.com/Joya"
